...
- Use `plonk clone` to detect which package managers your repo requires; install missing managers manually using the instructions provided by doctor
...
- Note: `plonk clone` helps identify required package managers; it does not install them automatically
