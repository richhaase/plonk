...
// AptManagerV2 manages APT packages using BaseManager for common functionality.
type AptManagerV2 struct {
	*BaseManager
}

// NewAptManagerV2 creates a new apt manager with the default executor.
func NewAptManagerV2() *AptManagerV2 {
...
// NewAptManagerV2WithExecutor creates a new apt manager with a custom executor for testing.
func NewAptManagerV2WithExecutor(exec executor.CommandExecutor) *AptManagerV2 {
	config := ManagerConfig{
		BinaryName:  "apt",
		VersionArgs: []string{"--version"},
		ListArgs: func() []string {
...
func (a *AptManagerV2) IsAvailable(ctx context.Context) (bool, error) {
...
func (a *AptManagerV2) ListInstalled(ctx context.Context) ([]string, error) {
...
func (a *AptManagerV2) parseListOutput(output []byte) []string {
...
func (a *AptManagerV2) Install(ctx context.Context, name string) error {
	return a.ExecuteInstall(ctx, name)
}

// Uninstall removes an APT package.
func (a *AptManagerV2) Uninstall(ctx context.Context, name string) error {
	return a.ExecuteUninstall(ctx, name)
}

// IsInstalled checks if a specific package is installed.
func (a *AptManagerV2) IsInstalled(ctx context.Context, name string) (bool, error) {
...
func (a *AptManagerV2) Search(ctx context.Context, query string) ([]string, error) {
...
func (a *AptManagerV2) parseSearchOutput(output []byte) []string {
	result := strings.TrimSpace(string(output))
...
func (a *AptManagerV2) Info(ctx context.Context, name string) (*PackageInfo, error) {
...
func (a *AptManagerV2) parseInfoOutput(output []byte, name string) *PackageInfo {
	info := &PackageInfo{
		Name: name,
	}
...
func (a *AptManagerV2) GetInstalledVersion(ctx context.Context, name string) (string, error) {
...
func (a *AptManagerV2) extractVersion(output []byte) string {
	lines := strings.Split(string(output), "\n")
	for _, line := range lines {
		line = strings.TrimSpace(line)
