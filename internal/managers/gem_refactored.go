...
// GemManagerV2 manages Ruby gems using BaseManager for common functionality.
type GemManagerV2 struct {
	*BaseManager
}

// NewGemManagerV2 creates a new gem manager with the default executor.
func NewGemManagerV2() *GemManagerV2 {
...
// NewGemManagerV2WithExecutor creates a new gem manager with a custom executor for testing.
func NewGemManagerV2WithExecutor(exec executor.CommandExecutor) *GemManagerV2 {
	config := ManagerConfig{
		BinaryName:  "gem",
		VersionArgs: []string{"--version"},
		ListArgs: func() []string {
...
func (g *GemManagerV2) ListInstalled(ctx context.Context) ([]string, error) {
...
func (g *GemManagerV2) parseListOutput(output []byte) []string {
...
func (g *GemManagerV2) Install(ctx context.Context, name string) error {
...
func (g *GemManagerV2) Uninstall(ctx context.Context, name string) error {
	return g.ExecuteUninstall(ctx, name)
}

// IsInstalled checks if a specific gem is installed.
func (g *GemManagerV2) IsInstalled(ctx context.Context, name string) (bool, error) {
...
func (g *GemManagerV2) Search(ctx context.Context, query string) ([]string, error) {
...
func (g *GemManagerV2) parseSearchOutput(output []byte) []string {
	result := strings.TrimSpace(string(output))
	if result == "" {
		return []string{}
	}
...
func (g *GemManagerV2) Info(ctx context.Context, name string) (*PackageInfo, error) {
...
func (g *GemManagerV2) parseInfoOutput(output []byte, name string) *PackageInfo {
	info := &PackageInfo{
		Name: name,
	}
...
func (g *GemManagerV2) getDependencies(ctx context.Context, name string) []string {
...
func (g *GemManagerV2) GetInstalledVersion(ctx context.Context, name string) (string, error) {
...
func (g *GemManagerV2) extractVersion(output []byte, name string) string {
	result := strings.TrimSpace(string(output))
