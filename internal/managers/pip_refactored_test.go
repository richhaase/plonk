...
func TestPipManagerV2_IsAvailable(t *testing.T) {
	tests := []struct {
		name      string
...
func TestPipManagerV2_ListInstalled(t *testing.T) {
	tests := []struct {
		name      string
		mockSetup func(m *mocks.MockCommandExecutor)
		want      []string
...
func TestPipManagerV2_Uninstall(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestPipManagerV2_IsInstalled(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestPipManagerV2_GetInstalledVersion(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestPipManagerV2_normalizeName(t *testing.T) {
	manager := NewPipManagerV2()
