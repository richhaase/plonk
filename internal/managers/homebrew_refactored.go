...
// HomebrewManagerV2 manages Homebrew packages using BaseManager for common functionality.
type HomebrewManagerV2 struct {
	*BaseManager
}

// NewHomebrewManagerV2 creates a new homebrew manager with the default executor.
func NewHomebrewManagerV2() *HomebrewManagerV2 {
	...
	return &HomebrewManagerV2{
		BaseManager: base,
	}
}

// NewHomebrewManagerV2WithExecutor creates a new homebrew manager with a custom executor for testing.
func NewHomebrewManagerV2WithExecutor(exec executor.CommandExecutor) *HomebrewManagerV2 {
	config := ManagerConfig{
		BinaryName:  "brew",
		VersionArgs: []string{"--version"},
		ListArgs: func() []string {
...
func (h *HomebrewManagerV2) ListInstalled(ctx context.Context) ([]string, error) {
...
func (h *HomebrewManagerV2) parseListOutput(output []byte) []string {
...
func (h *HomebrewManagerV2) Install(ctx context.Context, name string) error {
	return h.ExecuteInstall(ctx, name)
}

// Uninstall removes a Homebrew package.
func (h *HomebrewManagerV2) Uninstall(ctx context.Context, name string) error {
	return h.ExecuteUninstall(ctx, name)
}

// IsInstalled checks if a specific package is installed.
func (h *HomebrewManagerV2) IsInstalled(ctx context.Context, name string) (bool, error) {
...
func (h *HomebrewManagerV2) Search(ctx context.Context, query string) ([]string, error) {
...
func (h *HomebrewManagerV2) parseSearchOutput(output []byte) []string {
	result := strings.TrimSpace(string(output))
...
func (h *HomebrewManagerV2) Info(ctx context.Context, name string) (*PackageInfo, error) {
...
func (h *HomebrewManagerV2) parseInfoOutput(output []byte, name string) *PackageInfo {
	info := &PackageInfo{
		Name: name,
	}
...
func (h *HomebrewManagerV2) GetInstalledVersion(ctx context.Context, name string) (string, error) {
...
func (h *HomebrewManagerV2) extractVersion(output []byte, name string) string {
	result := strings.TrimSpace(string(output))
