...
func TestNpmManagerV2_ListInstalled(t *testing.T) {
	tests := []struct {
		name      string
...
/usr/local/lib/node_modules/@angular/cli`), nil)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			manager := NewNpmManagerV2WithExecutor(mockExecutor)
...
func TestNpmManagerV2_IsInstalled(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestNpmManagerV2_Search(t *testing.T) {
	tests := []struct {
		name      string
		query     string
		mockSetup func(m *mocks.MockCommandExecutor)
...
func TestNpmManagerV2_Info(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestNpmManagerV2_GetInstalledVersion(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
