...
func TestCargoManagerV2_IsAvailable(t *testing.T) {
	// Uses BaseManager.IsAvailable, so just test that it's properly initialized
	manager := NewCargoManagerV2()
...
func TestCargoManagerV2_ListInstalled(t *testing.T) {
	tests := []struct {
		name      string
...
exa v0.10.1:
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			manager := NewCargoManagerV2WithExecutor(mockExecutor)
...
func TestCargoManagerV2_IsInstalled(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestCargoManagerV2_Search(t *testing.T) {
	tests := []struct {
		name      string
		query     string
		mockSetup func(m *mocks.MockCommandExecutor)
...
func TestCargoManagerV2_Info(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestCargoManagerV2_GetInstalledVersion(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestCargoManagerV2_Install(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
...
func TestCargoManagerV2_Uninstall(t *testing.T) {
	tests := []struct {
		name        string
		packageName string
		mockSetup   func(m *mocks.MockCommandExecutor)
