...
import "github.com/richhaase/plonk/internal/managers"

// Compile-time interface compliance check
var _ managers.PackageConfigLoader = (*LockFileAdapter)(nil)
...
//
// Bridge: lock.LockService → managers.PackageConfigLoader
...
func (a *LockFileAdapter) GetPackagesForManager(managerName string) ([]managers.PackageConfigItem, error) {
	...
	items := make([]managers.PackageConfigItem, len(packages))
	for i, pkg := range packages {
		items[i] = managers.PackageConfigItem{
			Name: pkg.Name,
		}
	}
