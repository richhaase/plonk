...
// Source: internal/managers/interfaces.go
//
// Generated by this command:
//
//	mockgen -source=internal/managers/interfaces.go -destination=internal/mocks/package_manager_mocks.go -package=mocks
//
...
import (
	...
	managers "github.com/richhaase/plonk/internal/managers"
...
func (m *MockPackageManager) Info(ctx context.Context, name string) (*managers.PackageInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Info", ctx, name)
	ret0, _ := ret[0].(*managers.PackageInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockPackageConfigLoader) GetPackagesForManager(managerName string) ([]managers.PackageConfigItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPackagesForManager", managerName)
	ret0, _ := ret[0].([]managers.PackageConfigItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
